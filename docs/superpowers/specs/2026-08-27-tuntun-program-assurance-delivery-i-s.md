...
- The one inventoried 2020 Intel Mac is both office-use machine and sole canonical Core host. Phase 6 extends the accepted Phase 3 owner-ingress server; neither an unstated helper Mac nor a parallel HTTP server may carry authority.
...
|---|---:|---|---|
| Intel MacBook Pro 2020, 16 GB RAM | 1 | The single shared office-use machine and always-home Tuntun Core, owner API, initial recorder, and bounded local utilities; no second Mac is assumed | FileVault, sleep/power, thermal, network, SQLCipher, SSD, and long-soak gates. Family-ready Phase 1 single-homes it with Reachy on the ASUS/AiMesh L2; a direct BE800 link is disconnected unless the separate dual-home gate passes |
