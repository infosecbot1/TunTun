...
- Routine ingest uses codec stream-copy; no routine decoding, transcoding, or vision inference is allowed. This keeps the active Core Mac's CPU available for voice and policy work.
